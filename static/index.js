(function(){
    ...
    var raf;
    var arr = [];
    var textArr = backgroundWords.backgroundWords;
    for (var i = 0; i < 30; i++) {
        arr.push({
        ...
        draw: function(e) {
            ...
            if (e != null) {
                ...
                if (trueIndex != -1) {
                    ...
                    for (var i = 0; i < textArr[trueIndex].length; i++) {
                        ctx.save();
                        ctx.fillText(textArr[trueIndex].charAt(i), e.clientX+10, e.clientY + 35+i*16);
                        ctx.restore();
                    }
                    ctx.font = '16px 微软雅黑';
